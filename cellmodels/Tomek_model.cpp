...
{
ALGEBRAIC[hLss] = 1.00000/(1.00000+exp((STATES[(states_size * offset) + V]+87.6100)/7.48800));
ALGEBRAIC[hLssp] = 1.00000/(1.00000+exp((STATES[(states_size * offset) + V]+93.8100)/7.48800));
ALGEBRAIC[jcass] = 1.00000/(1.00000+exp((STATES[(states_size * offset) + V]+18.0800)/2.79160));
ALGEBRAIC[mss] = 1.00000/pow(1.00000+exp(- (STATES[(states_size * offset) + V]+56.8600)/9.03000), 2.00000);
ALGEBRAIC[tm] =  0.129200*exp(- pow((STATES[(states_size * offset) + V]+45.7900)/15.5400, 2.00000))+ 0.0648700*exp(- pow((STATES[(states_size * offset) + V] - 4.82300)/51.1200, 2.00000));
ALGEBRAIC[mLss] = 1.00000/(1.00000+exp(- (STATES[(states_size * offset) + V]+42.8500)/5.26400));
ALGEBRAIC[tmL] =  0.129200*exp(- pow((STATES[(states_size * offset) + V]+45.7900)/15.5400, 2.00000))+ 0.0648700*exp(- pow((STATES[(states_size * offset) + V] - 4.82300)/51.1200, 2.00000));
ALGEBRAIC[ass] = 1.00000/(1.00000+exp(- ((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]) - 14.3400)/14.8200));
ALGEBRAIC[ta] = 1.05150/(1.00000/( 1.20890*(1.00000+exp(- ((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]) - 18.4099)/29.3814)))+3.50000/(1.00000+exp((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+100.000)/29.3814)));
ALGEBRAIC[dss] = (STATES[(states_size * offset) + V]>=31.4978 ? 1.00000 :  1.07630*exp( - 1.00700*exp( - 0.0829000*STATES[(states_size * offset) + V])));
ALGEBRAIC[td] = CONSTANTS[(constants_size * offset) + offset]+0.600000+1.00000/(exp( - 0.0500000*(STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + vShift]+6.00000))+exp( 0.0900000*(STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + vShift]+14.0000)));
ALGEBRAIC[fss] = 1.00000/(1.00000+exp((STATES[(states_size * offset) + V]+19.5800)/3.69600));
ALGEBRAIC[tff] = 7.00000+1.00000/( 0.00450000*exp(- (STATES[(states_size * offset) + V]+20.0000)/10.0000)+ 0.00450000*exp((STATES[(states_size * offset) + V]+20.0000)/10.0000));
ALGEBRAIC[tfs] = 1000.00+1.00000/( 3.50000e-05*exp(- (STATES[(states_size * offset) + V]+5.00000)/4.00000)+ 3.50000e-05*exp((STATES[(states_size * offset) + V]+5.00000)/6.00000));
ALGEBRAIC[km2n] =  STATES[(states_size * offset) + jca]*1.00000;
ALGEBRAIC[anca_ss] = 1.00000/(CONSTANTS[(constants_size * offset) + k2n]/ALGEBRAIC[km2n]+pow(1.00000+CONSTANTS[(constants_size * offset) + Kmn]/STATES[(states_size * offset) + cass], 4.00000));
ALGEBRAIC[anca_i] = 1.00000/(CONSTANTS[(constants_size * offset) + k2n]/ALGEBRAIC[km2n]+pow(1.00000+CONSTANTS[(constants_size * offset) + Kmn]/STATES[(states_size * offset) + cai], 4.00000));
ALGEBRAIC[xs1ss] = 1.00000/(1.00000+exp(- (STATES[(states_size * offset) + V]+11.6000)/8.93200));
ALGEBRAIC[txs1] = 817.300+1.00000/( 0.000232600*exp((STATES[(states_size * offset) + V]+48.2800)/17.8000)+ 0.00129200*exp(- (STATES[(states_size * offset) + V]+210.000)/230.000));
ALGEBRAIC[assp] = 1.00000/(1.00000+exp(- ((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]) - 24.3400)/14.8200));
ALGEBRAIC[fcass] = ALGEBRAIC[fss];
ALGEBRAIC[tfcaf] = 7.00000+1.00000/( 0.0400000*exp(- (STATES[(states_size * offset) + V] - 4.00000)/7.00000)+ 0.0400000*exp((STATES[(states_size * offset) + V] - 4.00000)/7.00000));
ALGEBRAIC[tfcas] = 100.000+1.00000/( 0.000120000*exp(- STATES[(states_size * offset) + V]/3.00000)+ 0.000120000*exp(STATES[(states_size * offset) + V]/7.00000));
ALGEBRAIC[tffp] =  2.50000*ALGEBRAIC[tff];
ALGEBRAIC[xs2ss] = ALGEBRAIC[xs1ss];
ALGEBRAIC[txs2] = 1.00000/( 0.0100000*exp((STATES[(states_size * offset) + V] - 50.0000)/20.0000)+ 0.0193000*exp(- (STATES[(states_size * offset) + V]+66.5400)/31.0000));
ALGEBRAIC[CaMKb] = ( CONSTANTS[(constants_size * offset) + CaMKo]*(1.00000 - STATES[(states_size * offset) + CaMKt]))/(1.00000+CONSTANTS[(constants_size * offset) + KmCaM]/STATES[(states_size * offset) + cass]);
ALGEBRAIC[hss] = 1.00000/pow(1.00000+exp((STATES[(states_size * offset) + V]+71.5500)/7.43000), 2.00000);
ALGEBRAIC[ah] = (STATES[(states_size * offset) + V]>=- 40.0000 ? 0.00000 :  0.0570000*exp(- (STATES[(states_size * offset) + V]+80.0000)/6.80000));
ALGEBRAIC[bh] = (STATES[(states_size * offset) + V]>=- 40.0000 ? 0.770000/( 0.130000*(1.00000+exp(- (STATES[(states_size * offset) + V]+10.6600)/11.1000))) :  2.70000*exp( 0.0790000*STATES[(states_size * offset) + V])+ 310000.*exp( 0.348500*STATES[(states_size * offset) + V]));
ALGEBRAIC[th] = 1.00000/(ALGEBRAIC[ah]+ALGEBRAIC[bh]);
ALGEBRAIC[tfcafp] =  2.50000*ALGEBRAIC[tfcaf];
ALGEBRAIC[jss] = ALGEBRAIC[hss];
ALGEBRAIC[aj] = (STATES[(states_size * offset) + V]>=- 40.0000 ? 0.00000 : ( ( - 25428.0*exp( 0.244400*STATES[(states_size * offset) + V]) -  6.94800e-06*exp( - 0.0439100*STATES[(states_size * offset) + V]))*(STATES[(states_size * offset) + V]+37.7800))/(1.00000+exp( 0.311000*(STATES[(states_size * offset) + V]+79.2300))));
ALGEBRAIC[bj] = (STATES[(states_size * offset) + V]>=- 40.0000 ? ( 0.600000*exp( 0.0570000*STATES[(states_size * offset) + V]))/(1.00000+exp( - 0.100000*(STATES[(states_size * offset) + V]+32.0000))) : ( 0.0242400*exp( - 0.0105200*STATES[(states_size * offset) + V]))/(1.00000+exp( - 0.137800*(STATES[(states_size * offset) + V]+40.1400))));
ALGEBRAIC[tj] = 1.00000/(ALGEBRAIC[aj]+ALGEBRAIC[bj]);
ALGEBRAIC[hssp] = 1.00000/pow(1.00000+exp((STATES[(states_size * offset) + V]+77.5500)/7.43000), 2.00000);
ALGEBRAIC[iss] = 1.00000/(1.00000+exp((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+43.9400)/5.71100));
ALGEBRAIC[delta_epi] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 1.00000 - 0.950000/(1.00000+exp((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+70.0000)/5.00000)) : 1.00000);
ALGEBRAIC[tiF_b] = 4.56200+1.00000/( 0.393300*exp(- (STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+100.000)/100.000)+ 0.0800400*exp((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+50.0000)/16.5900));
ALGEBRAIC[tiF] =  ALGEBRAIC[tiF_b]*ALGEBRAIC[delta_epi];
ALGEBRAIC[vfrt] = ( STATES[(states_size * offset) + V]*CONSTANTS[(constants_size * offset) + F])/( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T]);
...
ALGEBRAIC[tiS_b] = 23.6200+1.00000/( 0.00141600*exp(- (STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+96.5200)/59.0500)+ 1.78000e-08*exp((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+114.100)/8.07900));
...
ALGEBRAIC[dti_develop] = 1.35400+0.000100000/(exp(((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]) - 167.400)/15.8900)+exp(- ((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]) - 12.2300)/0.215400));
ALGEBRAIC[dti_recover] = 1.00000 - 0.500000/(1.00000+exp((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]+70.0000)/20.0000));
...
ALGEBRAIC[f] =  CONSTANTS[(constants_size * offset) + Aff]*STATES[(states_size * offset) + ff]+ CONSTANTS[(constants_size * offset) + Afs]*STATES[(states_size * offset) + fs];
ALGEBRAIC[Afcaf] = 0.300000+0.600000/(1.00000+exp((STATES[(states_size * offset) + V] - 10.0000)/10.0000));
ALGEBRAIC[Afcas] = 1.00000 - ALGEBRAIC[Afcaf];
ALGEBRAIC[fca] =  ALGEBRAIC[Afcaf]*STATES[(states_size * offset) + fcaf]+ ALGEBRAIC[Afcas]*STATES[(states_size * offset) + fcas];
ALGEBRAIC[fp] =  CONSTANTS[(constants_size * offset) + Aff]*STATES[(states_size * offset) + ffp]+ CONSTANTS[(constants_size * offset) + Afs]*STATES[(states_size * offset) + fs];
ALGEBRAIC[fcap] =  ALGEBRAIC[Afcaf]*STATES[(states_size * offset) + fcafp]+ ALGEBRAIC[Afcas]*STATES[(states_size * offset) + fcas];
ALGEBRAIC[vffrt] = ( STATES[(states_size * offset) + V]*CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + F])/( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T]);
ALGEBRAIC[Iss] = ( 0.500000*(STATES[(states_size * offset) + nass]+STATES[(states_size * offset) + kss]+CONSTANTS[(constants_size * offset) + cli]+ 4.00000*STATES[(states_size * offset) + cass]))/1000.00;
ALGEBRAIC[gamma_cass] = exp( - CONSTANTS[(constants_size * offset) + constA]*4.00000*( pow(ALGEBRAIC[Iss], 1.0 / 2)/(1.00000+ pow(ALGEBRAIC[Iss], 1.0 / 2)) -  0.300000*ALGEBRAIC[Iss]));
ALGEBRAIC[PhiCaL_ss] = ( 4.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_cass]*STATES[(states_size * offset) + cass]*exp( 2.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_cao]*CONSTANTS[(constants_size * offset) + cao]))/(exp( 2.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[CaMKa] = ALGEBRAIC[CaMKb]+STATES[(states_size * offset) + CaMKt];
ALGEBRAIC[fICaLp] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[ICaL_ss] =  CONSTANTS[(constants_size * offset) + ICaL_fractionSS]*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCa]*ALGEBRAIC[PhiCaL_ss]*STATES[(states_size * offset) + d]*( ALGEBRAIC[f]*(1.00000 - STATES[(states_size * offset) + nca_ss])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fca]*STATES[(states_size * offset) + nca_ss])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCap]*ALGEBRAIC[PhiCaL_ss]*STATES[(states_size * offset) + d]*( ALGEBRAIC[fp]*(1.00000 - STATES[(states_size * offset) + nca_ss])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fcap]*STATES[(states_size * offset) + nca_ss]));
ALGEBRAIC[Jrel_inf_b] = (( - CONSTANTS[(constants_size * offset) + a_rel]*ALGEBRAIC[ICaL_ss])/1.00000)/(1.00000+pow(CONSTANTS[(constants_size * offset) + cajsr_half]/STATES[(states_size * offset) + cajsr], 8.00000));
ALGEBRAIC[Jrel_inf] = (CONSTANTS[(constants_size * offset) + celltype]==2.00000 ?  ALGEBRAIC[Jrel_inf_b]*1.70000 : ALGEBRAIC[Jrel_inf_b]);
ALGEBRAIC[tau_rel_b] = CONSTANTS[(constants_size * offset) + bt]/(1.00000+0.0123000/STATES[(states_size * offset) + cajsr]);
ALGEBRAIC[tau_rel] = (ALGEBRAIC[tau_rel_b]<0.00100000 ? 0.00100000 : ALGEBRAIC[tau_rel_b]);
ALGEBRAIC[Jrel_infp_b] = (( - CONSTANTS[(constants_size * offset) + a_relp]*ALGEBRAIC[ICaL_ss])/1.00000)/(1.00000+pow(CONSTANTS[(constants_size * offset) + cajsr_half]/STATES[(states_size * offset) + cajsr], 8.00000));
ALGEBRAIC[Jrel_infp] = (CONSTANTS[(constants_size * offset) + celltype]==2.00000 ?  ALGEBRAIC[Jrel_infp_b]*1.70000 : ALGEBRAIC[Jrel_infp_b]);
ALGEBRAIC[tau_relp_b] = CONSTANTS[(constants_size * offset) + btp]/(1.00000+0.0123000/STATES[(states_size * offset) + cajsr]);
ALGEBRAIC[tau_relp] = (ALGEBRAIC[tau_relp_b]<0.00100000 ? 0.00100000 : ALGEBRAIC[tau_relp_b]);
ALGEBRAIC[EK] =  (( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T])/( CONSTANTS[(constants_size * offset) + zk]*CONSTANTS[(constants_size * offset) + F]))*log(CONSTANTS[(constants_size * offset) + ko]/STATES[(states_size * offset) + ki]);
ALGEBRAIC[AiF] = 1.00000/(1.00000+exp(((STATES[(states_size * offset) + V]+CONSTANTS[(constants_size * offset) + EKshift]) - 213.600)/151.200));
ALGEBRAIC[AiS] = 1.00000 - ALGEBRAIC[AiF];
ALGEBRAIC[i] =  ALGEBRAIC[AiF]*STATES[(states_size * offset) + iF]+ ALGEBRAIC[AiS]*STATES[(states_size * offset) + iS];
ALGEBRAIC[ip] =  ALGEBRAIC[AiF]*STATES[(states_size * offset) + iFp]+ ALGEBRAIC[AiS]*STATES[(states_size * offset) + iSp];
ALGEBRAIC[fItop] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[Ito] =  CONSTANTS[(constants_size * offset) + Gto]*(STATES[(states_size * offset) + V] - ALGEBRAIC[EK])*( (1.00000 - ALGEBRAIC[fItop])*STATES[(states_size * offset) + a]*ALGEBRAIC[i]+ ALGEBRAIC[fItop]*STATES[(states_size * offset) + ap]*ALGEBRAIC[ip]);
ALGEBRAIC[IKr] =  CONSTANTS[(constants_size * offset) + GKr]* pow((CONSTANTS[(constants_size * offset) + ko]/5.00000), 1.0 / 2)*STATES[(states_size * offset) + O]*(STATES[(states_size * offset) + V] - ALGEBRAIC[EK]);
ALGEBRAIC[EKs] =  (( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T])/( CONSTANTS[(constants_size * offset) + zk]*CONSTANTS[(constants_size * offset) + F]))*log((CONSTANTS[(constants_size * offset) + ko]+ CONSTANTS[(constants_size * offset) + PKNa]*CONSTANTS[(constants_size * offset) + nao])/(STATES[(states_size * offset) + ki]+ CONSTANTS[(constants_size * offset) + PKNa]*STATES[(states_size * offset) + nai]));
ALGEBRAIC[KsCa] = 1.00000+0.600000/(1.00000+pow(3.80000e-05/STATES[(states_size * offset) + cai], 1.40000));
ALGEBRAIC[IKs] =  CONSTANTS[(constants_size * offset) + GKs]*ALGEBRAIC[KsCa]*STATES[(states_size * offset) + xs1]*STATES[(states_size * offset) + xs2]*(STATES[(states_size * offset) + V] - ALGEBRAIC[EKs]);
ALGEBRAIC[aK1] = 4.09400/(1.00000+exp( 0.121700*((STATES[(states_size * offset) + V] - ALGEBRAIC[EK]) - 49.9340)));
ALGEBRAIC[bK1] = ( 15.7200*exp( 0.0674000*((STATES[(states_size * offset) + V] - ALGEBRAIC[EK]) - 3.25700))+exp( 0.0618000*((STATES[(states_size * offset) + V] - ALGEBRAIC[EK]) - 594.310)))/(1.00000+exp( - 0.162900*((STATES[(states_size * offset) + V] - ALGEBRAIC[EK])+14.2070)));
ALGEBRAIC[K1ss] = ALGEBRAIC[aK1]/(ALGEBRAIC[aK1]+ALGEBRAIC[bK1]);
ALGEBRAIC[IK1] =  CONSTANTS[(constants_size * offset) + GK1]* pow((CONSTANTS[(constants_size * offset) + ko]/5.00000), 1.0 / 2)*ALGEBRAIC[K1ss]*(STATES[(states_size * offset) + V] - ALGEBRAIC[EK]);
ALGEBRAIC[Knao] =  CONSTANTS[(constants_size * offset) + Knao0]*exp(( (1.00000 - CONSTANTS[(constants_size * offset) + delta])*ALGEBRAIC[vfrt])/3.00000);
ALGEBRAIC[a3] = ( CONSTANTS[(constants_size * offset) + k3p]*pow(CONSTANTS[(constants_size * offset) + ko]/CONSTANTS[(constants_size * offset) + Kko], 2.00000))/((pow(1.00000+CONSTANTS[(constants_size * offset) + nao]/ALGEBRAIC[Knao], 3.00000)+pow(1.00000+CONSTANTS[(constants_size * offset) + ko]/CONSTANTS[(constants_size * offset) + Kko], 2.00000)) - 1.00000);
ALGEBRAIC[P] = CONSTANTS[(constants_size * offset) + eP]/(1.00000+CONSTANTS[(constants_size * offset) + H]/CONSTANTS[(constants_size * offset) + Khp]+STATES[(states_size * offset) + nai]/CONSTANTS[(constants_size * offset) + Knap]+STATES[(states_size * offset) + ki]/CONSTANTS[(constants_size * offset) + Kxkur]);
ALGEBRAIC[b3] = ( CONSTANTS[(constants_size * offset) + k3m]*ALGEBRAIC[P]*CONSTANTS[(constants_size * offset) + H])/(1.00000+CONSTANTS[(constants_size * offset) + MgATP]/CONSTANTS[(constants_size * offset) + Kmgatp]);
ALGEBRAIC[Knai] =  CONSTANTS[(constants_size * offset) + Knai0]*exp(( CONSTANTS[(constants_size * offset) + delta]*ALGEBRAIC[vfrt])/3.00000);
ALGEBRAIC[a1] = ( CONSTANTS[(constants_size * offset) + k1p]*pow(STATES[(states_size * offset) + nai]/ALGEBRAIC[Knai], 3.00000))/((pow(1.00000+STATES[(states_size * offset) + nai]/ALGEBRAIC[Knai], 3.00000)+pow(1.00000+STATES[(states_size * offset) + ki]/CONSTANTS[(constants_size * offset) + Kki], 2.00000)) - 1.00000);
ALGEBRAIC[b2] = ( CONSTANTS[(constants_size * offset) + k2m]*pow(CONSTANTS[(constants_size * offset) + nao]/ALGEBRAIC[Knao], 3.00000))/((pow(1.00000+CONSTANTS[(constants_size * offset) + nao]/ALGEBRAIC[Knao], 3.00000)+pow(1.00000+CONSTANTS[(constants_size * offset) + ko]/CONSTANTS[(constants_size * offset) + Kko], 2.00000)) - 1.00000);
ALGEBRAIC[b4] = ( CONSTANTS[(constants_size * offset) + k4m]*pow(STATES[(states_size * offset) + ki]/CONSTANTS[(constants_size * offset) + Kki], 2.00000))/((pow(1.00000+STATES[(states_size * offset) + nai]/ALGEBRAIC[Knai], 3.00000)+pow(1.00000+STATES[(states_size * offset) + ki]/CONSTANTS[(constants_size * offset) + Kki], 2.00000)) - 1.00000);
ALGEBRAIC[x1] =  CONSTANTS[(constants_size * offset) + a4]*ALGEBRAIC[a1]*CONSTANTS[(constants_size * offset) + a2]+ ALGEBRAIC[b2]*ALGEBRAIC[b4]*ALGEBRAIC[b3]+ CONSTANTS[(constants_size * offset) + a2]*ALGEBRAIC[b4]*ALGEBRAIC[b3]+ ALGEBRAIC[b3]*ALGEBRAIC[a1]*CONSTANTS[(constants_size * offset) + a2];
ALGEBRAIC[x2] =  ALGEBRAIC[b2]*CONSTANTS[(constants_size * offset) + b1]*ALGEBRAIC[b4]+ ALGEBRAIC[a1]*CONSTANTS[(constants_size * offset) + a2]*ALGEBRAIC[a3]+ ALGEBRAIC[a3]*CONSTANTS[(constants_size * offset) + b1]*ALGEBRAIC[b4]+ CONSTANTS[(constants_size * offset) + a2]*ALGEBRAIC[a3]*ALGEBRAIC[b4];
ALGEBRAIC[x3] =  CONSTANTS[(constants_size * offset) + a2]*ALGEBRAIC[a3]*CONSTANTS[(constants_size * offset) + a4]+ ALGEBRAIC[b3]*ALGEBRAIC[b2]*CONSTANTS[(constants_size * offset) + b1]+ ALGEBRAIC[b2]*CONSTANTS[(constants_size * offset) + b1]*CONSTANTS[(constants_size * offset) + a4]+ ALGEBRAIC[a3]*CONSTANTS[(constants_size * offset) + a4]*CONSTANTS[(constants_size * offset) + b1];
ALGEBRAIC[x4] =  ALGEBRAIC[b4]*ALGEBRAIC[b3]*ALGEBRAIC[b2]+ ALGEBRAIC[a3]*CONSTANTS[(constants_size * offset) + a4]*ALGEBRAIC[a1]+ ALGEBRAIC[b2]*CONSTANTS[(constants_size * offset) + a4]*ALGEBRAIC[a1]+ ALGEBRAIC[b3]*ALGEBRAIC[b2]*ALGEBRAIC[a1];
...
ALGEBRAIC[JnakK] =  2.00000*( ALGEBRAIC[E4]*CONSTANTS[(constants_size * offset) + b1] -  ALGEBRAIC[E3]*ALGEBRAIC[a1]);
ALGEBRAIC[INaK] =  CONSTANTS[(constants_size * offset) + Pnak]*( CONSTANTS[(constants_size * offset) + zna]*ALGEBRAIC[JnakNa]+ CONSTANTS[(constants_size * offset) + zk]*ALGEBRAIC[JnakK]);
ALGEBRAIC[xkb] = 1.00000/(1.00000+exp(- (STATES[(states_size * offset) + V] - 10.8968)/23.9871));
ALGEBRAIC[IKb] =  CONSTANTS[(constants_size * offset) + GKb]*ALGEBRAIC[xkb]*(STATES[(states_size * offset) + V] - ALGEBRAIC[EK]);
ALGEBRAIC[I_katp] =  CONSTANTS[(constants_size * offset) + fkatp]*CONSTANTS[(constants_size * offset) + gkatp]*CONSTANTS[(constants_size * offset) + akik]*CONSTANTS[(constants_size * offset) + bkik]*(STATES[(states_size * offset) + V] - ALGEBRAIC[EK]);
ALGEBRAIC[Istim] = (TIME>=CONSTANTS[(constants_size * offset) + stim_start]&&TIME<=CONSTANTS[(constants_size * offset) + i_Stim_End]&&(TIME - CONSTANTS[(constants_size * offset) + stim_start]) -  floor((TIME - CONSTANTS[(constants_size * offset) + stim_start])/CONSTANTS[(constants_size * offset) + BCL])*CONSTANTS[(constants_size * offset) + BCL]<=CONSTANTS[(constants_size * offset) + i_Stim_PulseDuration] ? CONSTANTS[(constants_size * offset) + i_Stim_Amplitude] : 0.00000);
ALGEBRAIC[Ii] = ( 0.500000*(STATES[(states_size * offset) + nai]+STATES[(states_size * offset) + ki]+CONSTANTS[(constants_size * offset) + cli]+ 4.00000*STATES[(states_size * offset) + cai]))/1000.00;
ALGEBRAIC[gamma_ki] = exp( - CONSTANTS[(constants_size * offset) + constA]*1.00000*( pow(ALGEBRAIC[Ii], 1.0 / 2)/(1.00000+ pow(ALGEBRAIC[Ii], 1.0 / 2)) -  0.300000*ALGEBRAIC[Ii]));
ALGEBRAIC[PhiCaK_i] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_ki]*STATES[(states_size * offset) + ki]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_ko]*CONSTANTS[(constants_size * offset) + ko]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaK_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + ICaL_fractionSS])*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaK]*ALGEBRAIC[PhiCaK_i]*STATES[(states_size * offset) + d]*( ALGEBRAIC[f]*(1.00000 - STATES[(states_size * offset) + nca_i])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fca]*STATES[(states_size * offset) + nca_i])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaKp]*ALGEBRAIC[PhiCaK_i]*STATES[(states_size * offset) + d]*( ALGEBRAIC[fp]*(1.00000 - STATES[(states_size * offset) + nca_i])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fcap]*STATES[(states_size * offset) + nca_i]));
ALGEBRAIC[JdiffK] = (STATES[(states_size * offset) + kss] - STATES[(states_size * offset) + ki])/CONSTANTS[(constants_size * offset) + tauK];
ALGEBRAIC[gamma_kss] = exp( - CONSTANTS[(constants_size * offset) + constA]*1.00000*( pow(ALGEBRAIC[Iss], 1.0 / 2)/(1.00000+ pow(ALGEBRAIC[Iss], 1.0 / 2)) -  0.300000*ALGEBRAIC[Iss]));
ALGEBRAIC[PhiCaK_ss] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_kss]*STATES[(states_size * offset) + kss]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_ko]*CONSTANTS[(constants_size * offset) + ko]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaK_ss] =  CONSTANTS[(constants_size * offset) + ICaL_fractionSS]*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaK]*ALGEBRAIC[PhiCaK_ss]*STATES[(states_size * offset) + d]*( ALGEBRAIC[f]*(1.00000 - STATES[(states_size * offset) + nca_ss])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fca]*STATES[(states_size * offset) + nca_ss])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaKp]*ALGEBRAIC[PhiCaK_ss]*STATES[(states_size * offset) + d]*( ALGEBRAIC[fp]*(1.00000 - STATES[(states_size * offset) + nca_ss])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fcap]*STATES[(states_size * offset) + nca_ss]));
ALGEBRAIC[ENa] =  (( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T])/( CONSTANTS[(constants_size * offset) + zna]*CONSTANTS[(constants_size * offset) + F]))*log(CONSTANTS[(constants_size * offset) + nao]/STATES[(states_size * offset) + nai]);
ALGEBRAIC[fINap] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[INa] =  CONSTANTS[(constants_size * offset) + GNa]*(STATES[(states_size * offset) + V] - ALGEBRAIC[ENa])*pow(STATES[(states_size * offset) + m], 3.00000)*( (1.00000 - ALGEBRAIC[fINap])*STATES[(states_size * offset) + h]*STATES[(states_size * offset) + j]+ ALGEBRAIC[fINap]*STATES[(states_size * offset) + hp]*STATES[(states_size * offset) + jp]);
ALGEBRAIC[fINaLp] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[INaL] =  CONSTANTS[(constants_size * offset) + GNaL]*(STATES[(states_size * offset) + V] - ALGEBRAIC[ENa])*STATES[(states_size * offset) + mL]*( (1.00000 - ALGEBRAIC[fINaLp])*STATES[(states_size * offset) + hL]+ ALGEBRAIC[fINaLp]*STATES[(states_size * offset) + hLp]);
ALGEBRAIC[allo_i] = 1.00000/(1.00000+pow(CONSTANTS[(constants_size * offset) + KmCaAct]/STATES[(states_size * offset) + cai], 2.00000));
ALGEBRAIC[hna] = exp( CONSTANTS[(constants_size * offset) + qna]*ALGEBRAIC[vfrt]);
ALGEBRAIC[h7_i] = 1.00000+ (CONSTANTS[(constants_size * offset) + nao]/CONSTANTS[(constants_size * offset) + kna3])*(1.00000+1.00000/ALGEBRAIC[hna]);
ALGEBRAIC[h8_i] = CONSTANTS[(constants_size * offset) + nao]/( CONSTANTS[(constants_size * offset) + kna3]*ALGEBRAIC[hna]*ALGEBRAIC[h7_i]);
ALGEBRAIC[k3pp_i] =  ALGEBRAIC[h8_i]*CONSTANTS[(constants_size * offset) + wnaca];
ALGEBRAIC[h1_i] = 1.00000+ (STATES[(states_size * offset) + nai]/CONSTANTS[(constants_size * offset) + kna3])*(1.00000+ALGEBRAIC[hna]);
ALGEBRAIC[h2_i] = ( STATES[(states_size * offset) + nai]*ALGEBRAIC[hna])/( CONSTANTS[(constants_size * offset) + kna3]*ALGEBRAIC[h1_i]);
ALGEBRAIC[k4pp_i] =  ALGEBRAIC[h2_i]*CONSTANTS[(constants_size * offset) + wnaca];
ALGEBRAIC[h4_i] = 1.00000+ (STATES[(states_size * offset) + nai]/CONSTANTS[(constants_size * offset) + kna1])*(1.00000+STATES[(states_size * offset) + nai]/CONSTANTS[(constants_size * offset) + kna2]);
ALGEBRAIC[h5_i] = ( STATES[(states_size * offset) + nai]*STATES[(states_size * offset) + nai])/( ALGEBRAIC[h4_i]*CONSTANTS[(constants_size * offset) + kna1]*CONSTANTS[(constants_size * offset) + kna2]);
ALGEBRAIC[k7_i] =  ALGEBRAIC[h5_i]*ALGEBRAIC[h2_i]*CONSTANTS[(constants_size * offset) + wna];
ALGEBRAIC[k8_i] =  ALGEBRAIC[h8_i]*CONSTANTS[(constants_size * offset) + h11_i]*CONSTANTS[(constants_size * offset) + wna];
ALGEBRAIC[h9_i] = 1.00000/ALGEBRAIC[h7_i];
ALGEBRAIC[k3p_i] =  ALGEBRAIC[h9_i]*CONSTANTS[(constants_size * offset) + wca];
ALGEBRAIC[k3_i] = ALGEBRAIC[k3p_i]+ALGEBRAIC[k3pp_i];
ALGEBRAIC[hca] = exp( CONSTANTS[(constants_size * offset) + qca]*ALGEBRAIC[vfrt]);
ALGEBRAIC[h3_i] = 1.00000/ALGEBRAIC[h1_i];
ALGEBRAIC[k4p_i] = ( ALGEBRAIC[h3_i]*CONSTANTS[(constants_size * offset) + wca])/ALGEBRAIC[hca];
ALGEBRAIC[k4_i] = ALGEBRAIC[k4p_i]+ALGEBRAIC[k4pp_i];
ALGEBRAIC[h6_i] = 1.00000/ALGEBRAIC[h4_i];
ALGEBRAIC[k6_i] =  ALGEBRAIC[h6_i]*STATES[(states_size * offset) + cai]*CONSTANTS[(constants_size * offset) + kcaon];
ALGEBRAIC[x1_i] =  CONSTANTS[(constants_size * offset) + k2_i]*ALGEBRAIC[k4_i]*(ALGEBRAIC[k7_i]+ALGEBRAIC[k6_i])+ CONSTANTS[(constants_size * offset) + k5_i]*ALGEBRAIC[k7_i]*(CONSTANTS[(constants_size * offset) + k2_i]+ALGEBRAIC[k3_i]);
ALGEBRAIC[x2_i] =  CONSTANTS[(constants_size * offset) + k1_i]*ALGEBRAIC[k7_i]*(ALGEBRAIC[k4_i]+CONSTANTS[(constants_size * offset) + k5_i])+ ALGEBRAIC[k4_i]*ALGEBRAIC[k6_i]*(CONSTANTS[(constants_size * offset) + k1_i]+ALGEBRAIC[k8_i]);
ALGEBRAIC[x3_i] =  CONSTANTS[(constants_size * offset) + k1_i]*ALGEBRAIC[k3_i]*(ALGEBRAIC[k7_i]+ALGEBRAIC[k6_i])+ ALGEBRAIC[k8_i]*ALGEBRAIC[k6_i]*(CONSTANTS[(constants_size * offset) + k2_i]+ALGEBRAIC[k3_i]);
ALGEBRAIC[x4_i] =  CONSTANTS[(constants_size * offset) + k2_i]*ALGEBRAIC[k8_i]*(ALGEBRAIC[k4_i]+CONSTANTS[(constants_size * offset) + k5_i])+ ALGEBRAIC[k3_i]*CONSTANTS[(constants_size * offset) + k5_i]*(CONSTANTS[(constants_size * offset) + k1_i]+ALGEBRAIC[k8_i]);
...
ALGEBRAIC[JncxCa_i] =  ALGEBRAIC[E2_i]*CONSTANTS[(constants_size * offset) + k2_i] -  ALGEBRAIC[E1_i]*CONSTANTS[(constants_size * offset) + k1_i];
ALGEBRAIC[INaCa_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + INaCa_fractionSS])*CONSTANTS[(constants_size * offset) + Gncx]*ALGEBRAIC[allo_i]*( CONSTANTS[(constants_size * offset) + zna]*ALGEBRAIC[JncxNa_i]+ CONSTANTS[(constants_size * offset) + zca]*ALGEBRAIC[JncxCa_i]);
ALGEBRAIC[INab] = ( CONSTANTS[(constants_size * offset) + PNab]*ALGEBRAIC[vffrt]*( STATES[(states_size * offset) + nai]*exp(ALGEBRAIC[vfrt]) - CONSTANTS[(constants_size * offset) + nao]))/(exp(ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[gamma_nai] = exp( - CONSTANTS[(constants_size * offset) + constA]*1.00000*( pow(ALGEBRAIC[Ii], 1.0 / 2)/(1.00000+ pow(ALGEBRAIC[Ii], 1.0 / 2)) -  0.300000*ALGEBRAIC[Ii]));
ALGEBRAIC[PhiCaNa_i] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_nai]*STATES[(states_size * offset) + nai]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_nao]*CONSTANTS[(constants_size * offset) + nao]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaNa_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + ICaL_fractionSS])*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaNa]*ALGEBRAIC[PhiCaNa_i]*STATES[(states_size * offset) + d]*( ALGEBRAIC[f]*(1.00000 - STATES[(states_size * offset) + nca_i])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fca]*STATES[(states_size * offset) + nca_i])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaNap]*ALGEBRAIC[PhiCaNa_i]*STATES[(states_size * offset) + d]*( ALGEBRAIC[fp]*(1.00000 - STATES[(states_size * offset) + nca_i])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fcap]*STATES[(states_size * offset) + nca_i]));
ALGEBRAIC[JdiffNa] = (STATES[(states_size * offset) + nass] - STATES[(states_size * offset) + nai])/CONSTANTS[(constants_size * offset) + tauNa];
ALGEBRAIC[allo_ss] = 1.00000/(1.00000+pow(CONSTANTS[(constants_size * offset) + KmCaAct]/STATES[(states_size * offset) + cass], 2.00000));
ALGEBRAIC[h7_ss] = 1.00000+ (CONSTANTS[(constants_size * offset) + nao]/CONSTANTS[(constants_size * offset) + kna3])*(1.00000+1.00000/ALGEBRAIC[hna]);
ALGEBRAIC[h8_ss] = CONSTANTS[(constants_size * offset) + nao]/( CONSTANTS[(constants_size * offset) + kna3]*ALGEBRAIC[hna]*ALGEBRAIC[h7_ss]);
ALGEBRAIC[k3pp_ss] =  ALGEBRAIC[h8_ss]*CONSTANTS[(constants_size * offset) + wnaca];
ALGEBRAIC[h1_ss] = 1.00000+ (STATES[(states_size * offset) + nass]/CONSTANTS[(constants_size * offset) + kna3])*(1.00000+ALGEBRAIC[hna]);
ALGEBRAIC[h2_ss] = ( STATES[(states_size * offset) + nass]*ALGEBRAIC[hna])/( CONSTANTS[(constants_size * offset) + kna3]*ALGEBRAIC[h1_ss]);
ALGEBRAIC[k4pp_ss] =  ALGEBRAIC[h2_ss]*CONSTANTS[(constants_size * offset) + wnaca];
ALGEBRAIC[h4_ss] = 1.00000+ (STATES[(states_size * offset) + nass]/CONSTANTS[(constants_size * offset) + kna1])*(1.00000+STATES[(states_size * offset) + nass]/CONSTANTS[(constants_size * offset) + kna2]);
ALGEBRAIC[h5_ss] = ( STATES[(states_size * offset) + nass]*STATES[(states_size * offset) + nass])/( ALGEBRAIC[h4_ss]*CONSTANTS[(constants_size * offset) + kna1]*CONSTANTS[(constants_size * offset) + kna2]);
ALGEBRAIC[k7_ss] =  ALGEBRAIC[h5_ss]*ALGEBRAIC[h2_ss]*CONSTANTS[(constants_size * offset) + wna];
ALGEBRAIC[k8_ss] =  ALGEBRAIC[h8_ss]*CONSTANTS[(constants_size * offset) + h11_ss]*CONSTANTS[(constants_size * offset) + wna];
ALGEBRAIC[h9_ss] = 1.00000/ALGEBRAIC[h7_ss];
ALGEBRAIC[k3p_ss] =  ALGEBRAIC[h9_ss]*CONSTANTS[(constants_size * offset) + wca];
ALGEBRAIC[k3_ss] = ALGEBRAIC[k3p_ss]+ALGEBRAIC[k3pp_ss];
ALGEBRAIC[h3_ss] = 1.00000/ALGEBRAIC[h1_ss];
ALGEBRAIC[k4p_ss] = ( ALGEBRAIC[h3_ss]*CONSTANTS[(constants_size * offset) + wca])/ALGEBRAIC[hca];
ALGEBRAIC[k4_ss] = ALGEBRAIC[k4p_ss]+ALGEBRAIC[k4pp_ss];
ALGEBRAIC[h6_ss] = 1.00000/ALGEBRAIC[h4_ss];
ALGEBRAIC[k6_ss] =  ALGEBRAIC[h6_ss]*STATES[(states_size * offset) + cass]*CONSTANTS[(constants_size * offset) + kcaon];
ALGEBRAIC[x1_ss] =  CONSTANTS[(constants_size * offset) + k2_ss]*ALGEBRAIC[k4_ss]*(ALGEBRAIC[k7_ss]+ALGEBRAIC[k6_ss])+ CONSTANTS[(constants_size * offset) + k5_ss]*ALGEBRAIC[k7_ss]*(CONSTANTS[(constants_size * offset) + k2_ss]+ALGEBRAIC[k3_ss]);
ALGEBRAIC[x2_ss] =  CONSTANTS[(constants_size * offset) + k1_ss]*ALGEBRAIC[k7_ss]*(ALGEBRAIC[k4_ss]+CONSTANTS[(constants_size * offset) + k5_ss])+ ALGEBRAIC[k4_ss]*ALGEBRAIC[k6_ss]*(CONSTANTS[(constants_size * offset) + k1_ss]+ALGEBRAIC[k8_ss]);
ALGEBRAIC[x3_ss] =  CONSTANTS[(constants_size * offset) + k1_ss]*ALGEBRAIC[k3_ss]*(ALGEBRAIC[k7_ss]+ALGEBRAIC[k6_ss])+ ALGEBRAIC[k8_ss]*ALGEBRAIC[k6_ss]*(CONSTANTS[(constants_size * offset) + k2_ss]+ALGEBRAIC[k3_ss]);
ALGEBRAIC[x4_ss] =  CONSTANTS[(constants_size * offset) + k2_ss]*ALGEBRAIC[k8_ss]*(ALGEBRAIC[k4_ss]+CONSTANTS[(constants_size * offset) + k5_ss])+ ALGEBRAIC[k3_ss]*CONSTANTS[(constants_size * offset) + k5_ss]*(CONSTANTS[(constants_size * offset) + k1_ss]+ALGEBRAIC[k8_ss]);
...
ALGEBRAIC[JncxCa_ss] =  ALGEBRAIC[E2_ss]*CONSTANTS[(constants_size * offset) + k2_ss] -  ALGEBRAIC[E1_ss]*CONSTANTS[(constants_size * offset) + k1_ss];
ALGEBRAIC[INaCa_ss] =  CONSTANTS[(constants_size * offset) + INaCa_fractionSS]*CONSTANTS[(constants_size * offset) + Gncx]*ALGEBRAIC[allo_ss]*( CONSTANTS[(constants_size * offset) + zna]*ALGEBRAIC[JncxNa_ss]+ CONSTANTS[(constants_size * offset) + zca]*ALGEBRAIC[JncxCa_ss]);
ALGEBRAIC[gamma_nass] = exp( - CONSTANTS[(constants_size * offset) + constA]*1.00000*( pow(ALGEBRAIC[Iss], 1.0 / 2)/(1.00000+ pow(ALGEBRAIC[Iss], 1.0 / 2)) -  0.300000*ALGEBRAIC[Iss]));
ALGEBRAIC[PhiCaNa_ss] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_nass]*STATES[(states_size * offset) + nass]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_nao]*CONSTANTS[(constants_size * offset) + nao]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaNa_ss] =  CONSTANTS[(constants_size * offset) + ICaL_fractionSS]*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaNa]*ALGEBRAIC[PhiCaNa_ss]*STATES[(states_size * offset) + d]*( ALGEBRAIC[f]*(1.00000 - STATES[(states_size * offset) + nca_ss])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fca]*STATES[(states_size * offset) + nca_ss])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaNap]*ALGEBRAIC[PhiCaNa_ss]*STATES[(states_size * offset) + d]*( ALGEBRAIC[fp]*(1.00000 - STATES[(states_size * offset) + nca_ss])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fcap]*STATES[(states_size * offset) + nca_ss]));
ALGEBRAIC[Jdiff] = (STATES[(states_size * offset) + cass] - STATES[(states_size * offset) + cai])/CONSTANTS[(constants_size * offset) + tauCa];
ALGEBRAIC[fJrelp] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[Jrel] =  CONSTANTS[(constants_size * offset) + Jrel_b]*( (1.00000 - ALGEBRAIC[fJrelp])*STATES[(states_size * offset) + Jrel_np]+ ALGEBRAIC[fJrelp]*STATES[(states_size * offset) + Jrel_p]);
ALGEBRAIC[Bcass] = 1.00000/(1.00000+( CONSTANTS[(constants_size * offset) + BSRmax]*CONSTANTS[(constants_size * offset) + KmBSR])/pow(CONSTANTS[(constants_size * offset) + KmBSR]+STATES[(states_size * offset) + cass], 2.00000)+( CONSTANTS[(constants_size * offset) + BSLmax]*CONSTANTS[(constants_size * offset) + KmBSL])/pow(CONSTANTS[(constants_size * offset) + KmBSL]+STATES[(states_size * offset) + cass], 2.00000));
ALGEBRAIC[gamma_cai] = exp( - CONSTANTS[(constants_size * offset) + constA]*4.00000*( pow(ALGEBRAIC[Ii], 1.0 / 2)/(1.00000+ pow(ALGEBRAIC[Ii], 1.0 / 2)) -  0.300000*ALGEBRAIC[Ii]));
ALGEBRAIC[PhiCaL_i] = ( 4.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_cai]*STATES[(states_size * offset) + cai]*exp( 2.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_cao]*CONSTANTS[(constants_size * offset) + cao]))/(exp( 2.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaL_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + ICaL_fractionSS])*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCa]*ALGEBRAIC[PhiCaL_i]*STATES[(states_size * offset) + d]*( ALGEBRAIC[f]*(1.00000 - STATES[(states_size * offset) + nca_i])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fca]*STATES[(states_size * offset) + nca_i])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCap]*ALGEBRAIC[PhiCaL_i]*STATES[(states_size * offset) + d]*( ALGEBRAIC[fp]*(1.00000 - STATES[(states_size * offset) + nca_i])+ STATES[(states_size * offset) + jca]*ALGEBRAIC[fcap]*STATES[(states_size * offset) + nca_i]));
...
ALGEBRAIC[IpCa] = ( CONSTANTS[(constants_size * offset) + GpCa]*STATES[(states_size * offset) + cai])/(CONSTANTS[(constants_size * offset) + KmCap]+STATES[(states_size * offset) + cai]);
ALGEBRAIC[ICab] = ( CONSTANTS[(constants_size * offset) + PCab]*4.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_cai]*STATES[(states_size * offset) + cai]*exp( 2.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_cao]*CONSTANTS[(constants_size * offset) + cao]))/(exp( 2.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[IClCa_junc] =  (( CONSTANTS[(constants_size * offset) + Fjunc]*CONSTANTS[(constants_size * offset) + GClCa])/(1.00000+CONSTANTS[(constants_size * offset) + KdClCa]/STATES[(states_size * offset) + cass]))*(STATES[(states_size * offset) + V] - CONSTANTS[(constants_size * offset) + ECl]);
ALGEBRAIC[IClCa_sl] =  (( (1.00000 - CONSTANTS[(constants_size * offset) + Fjunc])*CONSTANTS[(constants_size * offset) + GClCa])/(1.00000+CONSTANTS[(constants_size * offset) + KdClCa]/STATES[(states_size * offset) + cai]))*(STATES[(states_size * offset) + V] - CONSTANTS[(constants_size * offset) + ECl]);
ALGEBRAIC[IClCa] = ALGEBRAIC[IClCa_junc]+ALGEBRAIC[IClCa_sl];
ALGEBRAIC[IClb] =  CONSTANTS[(constants_size * offset) + GClb]*(STATES[(states_size * offset) + V] - CONSTANTS[(constants_size * offset) + ECl]);
ALGEBRAIC[Jupnp] = ( CONSTANTS[(constants_size * offset) + upScale]*0.00542500*STATES[(states_size * offset) + cai])/(STATES[(states_size * offset) + cai]+0.000920000);
ALGEBRAIC[Jupp] = ( CONSTANTS[(constants_size * offset) + upScale]*2.75000*0.00542500*STATES[(states_size * offset) + cai])/((STATES[(states_size * offset) + cai]+0.000920000) - 0.000170000);
ALGEBRAIC[fJupp] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[Jleak] = ( 0.00488250*STATES[(states_size * offset) + cansr])/15.0000;
ALGEBRAIC[Jup] =  CONSTANTS[(constants_size * offset) + Jup_b]*(( (1.00000 - ALGEBRAIC[fJupp])*ALGEBRAIC[Jupnp]+ ALGEBRAIC[fJupp]*ALGEBRAIC[Jupp]) - ALGEBRAIC[Jleak]);
ALGEBRAIC[Bcai] = 1.00000/(1.00000+( CONSTANTS[(constants_size * offset) + cmdnmax]*CONSTANTS[(constants_size * offset) + kmcmdn])/pow(CONSTANTS[(constants_size * offset) + kmcmdn]+STATES[(states_size * offset) + cai], 2.00000)+( CONSTANTS[(constants_size * offset) + trpnmax]*CONSTANTS[(constants_size * offset) + kmtrpn])/pow(CONSTANTS[(constants_size * offset) + kmtrpn]+STATES[(states_size * offset) + cai], 2.00000));
ALGEBRAIC[Jtr] = (STATES[(states_size * offset) + cansr] - STATES[(states_size * offset) + cajsr])/60.0000;
ALGEBRAIC[Bcajsr] = 1.00000/(1.00000+( CONSTANTS[(constants_size * offset) + csqnmax]*CONSTANTS[(constants_size * offset) + kmcsqn])/pow(CONSTANTS[(constants_size * offset) + kmcsqn]+STATES[(states_size * offset) + cajsr], 2.00000));

RATES[hL] = (ALGEBRAIC[hLss] - STATES[(states_size * offset) + hL])/CONSTANTS[(constants_size * offset) + thL];
RATES[hLp] = (ALGEBRAIC[hLssp] - STATES[(states_size * offset) + hLp])/CONSTANTS[(constants_size * offset) + thLp];
RATES[jca] = (ALGEBRAIC[jcass] - STATES[(states_size * offset) + jca])/CONSTANTS[(constants_size * offset) + tjca];
RATES[m] = (ALGEBRAIC[mss] - STATES[(states_size * offset) + m])/ALGEBRAIC[tm];
RATES[mL] = (ALGEBRAIC[mLss] - STATES[(states_size * offset) + mL])/ALGEBRAIC[tmL];
RATES[a] = (ALGEBRAIC[ass] - STATES[(states_size * offset) + a])/ALGEBRAIC[ta];
RATES[d] = (ALGEBRAIC[dss] - STATES[(states_size * offset) + d])/ALGEBRAIC[td];
RATES[ff] = (ALGEBRAIC[fss] - STATES[(states_size * offset) + ff])/ALGEBRAIC[tff];
RATES[fs] = (ALGEBRAIC[fss] - STATES[(states_size * offset) + fs])/ALGEBRAIC[tfs];
RATES[nca_ss] =  ALGEBRAIC[anca_ss]*CONSTANTS[(constants_size * offset) + k2n] -  STATES[(states_size * offset) + nca_ss]*ALGEBRAIC[km2n];
RATES[nca_i] =  ALGEBRAIC[anca_i]*CONSTANTS[(constants_size * offset) + k2n] -  STATES[(states_size * offset) + nca_i]*ALGEBRAIC[km2n];
RATES[xs1] = (ALGEBRAIC[xs1ss] - STATES[(states_size * offset) + xs1])/ALGEBRAIC[txs1];
RATES[ap] = (ALGEBRAIC[assp] - STATES[(states_size * offset) + ap])/ALGEBRAIC[ta];
RATES[fcaf] = (ALGEBRAIC[fcass] - STATES[(states_size * offset) + fcaf])/ALGEBRAIC[tfcaf];
RATES[fcas] = (ALGEBRAIC[fcass] - STATES[(states_size * offset) + fcas])/ALGEBRAIC[tfcas];
RATES[ffp] = (ALGEBRAIC[fss] - STATES[(states_size * offset) + ffp])/ALGEBRAIC[tffp];
RATES[xs2] = (ALGEBRAIC[xs2ss] - STATES[(states_size * offset) + xs2])/ALGEBRAIC[txs2];
RATES[CaMKt] =  CONSTANTS[(constants_size * offset) + aCaMK]*ALGEBRAIC[CaMKb]*(ALGEBRAIC[CaMKb]+STATES[(states_size * offset) + CaMKt]) -  CONSTANTS[(constants_size * offset) + bCaMK]*STATES[(states_size * offset) + CaMKt];
RATES[h] = (ALGEBRAIC[hss] - STATES[(states_size * offset) + h])/ALGEBRAIC[th];
RATES[fcafp] = (ALGEBRAIC[fcass] - STATES[(states_size * offset) + fcafp])/ALGEBRAIC[tfcafp];
RATES[j] = (ALGEBRAIC[jss] - STATES[(states_size * offset) + j])/ALGEBRAIC[tj];
RATES[hp] = (ALGEBRAIC[hssp] - STATES[(states_size * offset) + hp])/ALGEBRAIC[th];
RATES[iF] = (ALGEBRAIC[iss] - STATES[(states_size * offset) + iF])/ALGEBRAIC[tiF];
RATES[C3] =  ALGEBRAIC[beta]*STATES[(states_size * offset) + C2] -  ALGEBRAIC[alpha]*STATES[(states_size * offset) + C3];
RATES[C2] = ( ALGEBRAIC[alpha]*STATES[(states_size * offset) + C3]+ CONSTANTS[(constants_size * offset) + beta_1]*STATES[(states_size * offset) + C1]) -  (ALGEBRAIC[beta]+CONSTANTS[(constants_size * offset) + alpha_1])*STATES[(states_size * offset) + C2];
RATES[jp] = (ALGEBRAIC[jss] - STATES[(states_size * offset) + jp])/ALGEBRAIC[tjp];
RATES[iS] = (ALGEBRAIC[iss] - STATES[(states_size * offset) + iS])/ALGEBRAIC[tiS];
RATES[O] = ( ALGEBRAIC[alpha_2]*STATES[(states_size * offset) + C1]+ ALGEBRAIC[beta_i]*STATES[(states_size * offset) + I]) -  (ALGEBRAIC[beta_2]+ALGEBRAIC[alpha_i])*STATES[(states_size * offset) + O];
RATES[iFp] = (ALGEBRAIC[iss] - STATES[(states_size * offset) + iFp])/ALGEBRAIC[tiFp];
RATES[iSp] = (ALGEBRAIC[iss] - STATES[(states_size * offset) + iSp])/ALGEBRAIC[tiSp];
RATES[C1] = ( CONSTANTS[(constants_size * offset) + alpha_1]*STATES[(states_size * offset) + C2]+ ALGEBRAIC[beta_2]*STATES[(states_size * offset) + O]+ ALGEBRAIC[beta_ItoC2]*STATES[(states_size * offset) + I]) -  (CONSTANTS[(constants_size * offset) + beta_1]+ALGEBRAIC[alpha_2]+ALGEBRAIC[alpha_C2ToI])*STATES[(states_size * offset) + C1];
RATES[I] = ( ALGEBRAIC[alpha_C2ToI]*STATES[(states_size * offset) + C1]+ ALGEBRAIC[alpha_i]*STATES[(states_size * offset) + O]) -  (ALGEBRAIC[beta_ItoC2]+ALGEBRAIC[beta_i])*STATES[(states_size * offset) + I];
RATES[Jrel_np] = (ALGEBRAIC[Jrel_inf] - STATES[(states_size * offset) + Jrel_np])/ALGEBRAIC[tau_rel];
RATES[Jrel_p] = (ALGEBRAIC[Jrel_infp] - STATES[(states_size * offset) + Jrel_p])/ALGEBRAIC[tau_relp];
RATES[ki] = ( - (((ALGEBRAIC[Ito]+ALGEBRAIC[IKr]+ALGEBRAIC[IKs]+ALGEBRAIC[IK1]+ALGEBRAIC[IKb]+ALGEBRAIC[I_katp]+ALGEBRAIC[Istim]) -  2.00000*ALGEBRAIC[INaK])+ALGEBRAIC[ICaK_i])*CONSTANTS[(constants_size * offset) + Acap])/( CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + vmyo])+( ALGEBRAIC[JdiffK]*CONSTANTS[(constants_size * offset) + vss])/CONSTANTS[(constants_size * offset) + vmyo];
RATES[kss] = ( - ALGEBRAIC[ICaK_ss]*CONSTANTS[(constants_size * offset) + Acap])/( CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + vss]) - ALGEBRAIC[JdiffK];
RATES[nai] = ( - (ALGEBRAIC[INa]+ALGEBRAIC[INaL]+ 3.00000*ALGEBRAIC[INaCa_i]+ALGEBRAIC[ICaNa_i]+ 3.00000*ALGEBRAIC[INaK]+ALGEBRAIC[INab])*CONSTANTS[(constants_size * offset) + Acap])/( CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + vmyo])+( ALGEBRAIC[JdiffNa]*CONSTANTS[(constants_size * offset) + vss])/CONSTANTS[(constants_size * offset) + vmyo];
RATES[nass] = ( - (ALGEBRAIC[ICaNa_ss]+ 3.00000*ALGEBRAIC[INaCa_ss])*CONSTANTS[(constants_size * offset) + Acap])/( CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + vss]) - ALGEBRAIC[JdiffNa];
RATES[cass] =  ALGEBRAIC[Bcass]*((( - (ALGEBRAIC[ICaL_ss] -  2.00000*ALGEBRAIC[INaCa_ss])*CONSTANTS[(constants_size * offset) + Acap])/( 2.00000*CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + vss])+( ALGEBRAIC[Jrel]*CONSTANTS[(constants_size * offset) + vjsr])/CONSTANTS[(constants_size * offset) + vss]) - ALGEBRAIC[Jdiff]);
...
RATES[cai] =  ALGEBRAIC[Bcai]*((( - ((ALGEBRAIC[ICaL_i]+ALGEBRAIC[IpCa]+ALGEBRAIC[ICab]) -  2.00000*ALGEBRAIC[INaCa_i])*CONSTANTS[(constants_size * offset) + Acap])/( 2.00000*CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + vmyo]) - ( ALGEBRAIC[Jup]*CONSTANTS[(constants_size * offset) + vnsr])/CONSTANTS[(constants_size * offset) + vmyo])+( ALGEBRAIC[Jdiff]*CONSTANTS[(constants_size * offset) + vss])/CONSTANTS[(constants_size * offset) + vmyo]);
RATES[cansr] = ALGEBRAIC[Jup] - ( ALGEBRAIC[Jtr]*CONSTANTS[(constants_size * offset) + vjsr])/CONSTANTS[(constants_size * offset) + vnsr];
...
////==============
////INa
  STATES[(states_size * offset) + m] = ALGEBRAIC[mss] - (ALGEBRAIC[mss] - STATES[(states_size * offset) + m]) * exp(-dt / ALGEBRAIC[tm]);
  STATES[(states_size * offset) + h] = ALGEBRAIC[hss] - (ALGEBRAIC[hss] - STATES[(states_size * offset) + h]) * exp(-dt / ALGEBRAIC[th]);
  STATES[(states_size * offset) + j] = ALGEBRAIC[jss] - (ALGEBRAIC[jss] - STATES[(states_size * offset) + j]) * exp(-dt / ALGEBRAIC[tj]);
  STATES[(states_size * offset) + hp] = ALGEBRAIC[hssp] - (ALGEBRAIC[hssp] - STATES[(states_size * offset) + hp]) * exp(-dt / ALGEBRAIC[th]);
  STATES[(states_size * offset) + jp] = ALGEBRAIC[jss] - (ALGEBRAIC[jss] - STATES[(states_size * offset) + jp]) * exp(-dt / ALGEBRAIC[tjp]);
  STATES[(states_size * offset) + mL] = ALGEBRAIC[mLss] - (ALGEBRAIC[mLss] - STATES[(states_size * offset) + mL]) * exp(-dt / ALGEBRAIC[tmL]);
  STATES[(states_size * offset) + hL] = ALGEBRAIC[hLss] - (ALGEBRAIC[hLss] - STATES[(states_size * offset) + hL]) * exp(-dt / CONSTANTS[(constants_size * offset) + thL]);
  STATES[(states_size * offset) + hLp] = ALGEBRAIC[hLssp] - (ALGEBRAIC[hLssp] - STATES[(states_size * offset) + hLp]) * exp(-dt / CONSTANTS[(constants_size * offset) + thLp]);
////Ito
  STATES[(states_size * offset) + a] = ALGEBRAIC[ass] - (ALGEBRAIC[ass] - STATES[(states_size * offset) + a]) * exp(-dt / ALGEBRAIC[ta]);
  STATES[(states_size * offset) + iF] = ALGEBRAIC[iss] - (ALGEBRAIC[iss] - STATES[(states_size * offset) + iF]) * exp(-dt / ALGEBRAIC[tiF]);
  STATES[(states_size * offset) + iS] = ALGEBRAIC[iss] - (ALGEBRAIC[iss] - STATES[(states_size * offset) + iS]) * exp(-dt / ALGEBRAIC[tiS]);
  STATES[(states_size * offset) + ap] = ALGEBRAIC[assp] - (ALGEBRAIC[assp] - STATES[(states_size * offset) + ap]) * exp(-dt / ALGEBRAIC[ta]);
  STATES[(states_size * offset) + iFp] = ALGEBRAIC[iss] - (ALGEBRAIC[iss] - STATES[(states_size * offset) + iFp]) * exp(-dt / ALGEBRAIC[tiFp]);
  STATES[(states_size * offset) + iSp] = ALGEBRAIC[iss] - (ALGEBRAIC[iss] - STATES[(states_size * offset) + iSp]) * exp(-dt / ALGEBRAIC[tiSp]);
////ICaL
  STATES[(states_size * offset) + d] = ALGEBRAIC[dss] - (ALGEBRAIC[dss] - STATES[(states_size * offset) + d]) * exp(-dt / ALGEBRAIC[td]);
  STATES[(states_size * offset) + ff] = ALGEBRAIC[fss] - (ALGEBRAIC[fss] - STATES[(states_size * offset) + ff]) * exp(-dt / ALGEBRAIC[tff]);
  STATES[(states_size * offset) + fs] = ALGEBRAIC[fss] - (ALGEBRAIC[fss] - STATES[(states_size * offset) + fs]) * exp(-dt / ALGEBRAIC[tfs]);
  STATES[(states_size * offset) + fcaf] = ALGEBRAIC[fcass] - (ALGEBRAIC[fcass] - STATES[(states_size * offset) + fcaf]) * exp(-dt / ALGEBRAIC[tfcaf]);
  STATES[(states_size * offset) + fcas] = ALGEBRAIC[fcass] - (ALGEBRAIC[fcass] - STATES[(states_size * offset) + fcas]) * exp(-dt / ALGEBRAIC[tfcas]);
  STATES[(states_size * offset) + jca] = ALGEBRAIC[jcass] - (ALGEBRAIC[jcass] - STATES[(states_size * offset) + jca]) * exp(- dt / CONSTANTS[(constants_size * offset) + tjca]);
  STATES[(states_size * offset) + ffp] = ALGEBRAIC[fss] - (ALGEBRAIC[fss] - STATES[(states_size * offset) + ffp]) * exp(-dt / ALGEBRAIC[tffp]);
  STATES[(states_size * offset) + fcafp] = ALGEBRAIC[fcass] - (ALGEBRAIC[fcass] - STATES[(states_size * offset) + fcafp]) * exp(-d / ALGEBRAIC[tfcafp]);
	STATES[(states_size * offset) + nca_i] = STATES[(states_size * offset) + nca_i] + RATES[nca_i]*dt;
	STATES[(states_size * offset) + nca_ss] = STATES[(states_size * offset) + nca_ss] + RATES[nca_ss]*dt;
//  STATES[nca_i] = ALGEBRAIC[anca_i] * CONSTANTS[(constants_size * offset) + k2n] / ALGEBRAIC[km2n] -
//      (ALGEBRAIC[anca_i] * CONSTANTS[(constants_size * offset) + k2n] / ALGEBRAIC[km2n] - STATES[nca_i]) * exp(-ALGEBRAIC[km2n] * dt);
...
////IKr
  ...
  coeffs[8] = -  (CONSTANTS[(constants_size * offset) + beta_1]+ALGEBRAIC[alpha_2]+ALGEBRAIC[alpha_C2ToI]);
  coeffs[9] = CONSTANTS[(constants_size * offset) + alpha_1];
  coeffs[10] = CONSTANTS[(constants_size * offset) + beta_1];
  coeffs[11] = -  (ALGEBRAIC[beta]+CONSTANTS[(constants_size * offset) + alpha_1]);
...
////IKs
  STATES[(states_size * offset) + xs1] = ALGEBRAIC[xs1ss] - (ALGEBRAIC[xs1ss] - STATES[(states_size * offset) + xs1]) * exp(-dt / ALGEBRAIC[txs1]);
  STATES[(states_size * offset) + xs2] = ALGEBRAIC[xs2ss] - (ALGEBRAIC[xs2ss] - STATES[(states_size * offset) + xs2]) * exp(-dt / ALGEBRAIC[txs2]);
////IK1
////RyR receptors
  STATES[(states_size * offset) + Jrel_np] = ALGEBRAIC[Jrel_inf] - (ALGEBRAIC[Jrel_inf] - STATES[(states_size * offset) + Jrel_np]) * exp(-dt / ALGEBRAIC[tau_rel]);
  STATES[(states_size * offset) + Jrel_p] = ALGEBRAIC[Jrel_infp] - (ALGEBRAIC[Jrel_infp] - STATES[(states_size * offset) + Jrel_p]) * exp(-dt / ALGEBRAIC[tau_relp]);
////=============================
