...
STATES[V] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ?  -89.14 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ?  -89.1704 : -88.7638);
...
STATES[CaMKt] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.0129 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.0192 : 0.0111);
STATES[cass] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 5.77E-05 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 6.58E-05 : 7.0305e-5);
...
STATES[nai] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 12.1025 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 15.0038 : 12.1025);
STATES[nass] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 12.8366 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 15.0043 : 12.1029);
STATES[ki] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 142.6951 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 143.0403 : 142.3002);
STATES[kss] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 142.6951 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 143.0402 : 142.3002);
STATES[cansr] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 1.8119 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 1.9557 : 1.5211);
STATES[cajsr] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 1.8102 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 1.9593 : 1.5214);
STATES[cai] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 6.63E-05 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 8.17E-05 : 8.1583e-05);
...
STATES[m] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 7.43E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 7.38E-04 : 8.0572e-4);
STATES[h] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.836 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.8365 : 0.8286);
STATES[j] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.8359 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.8363 : 0.8284);
STATES[hp] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.6828 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.6838 : 0.6707);
STATES[jp] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.8357 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.8358 : 0.8281);
CONSTANTS[(constants_size * offset) + GNa] = 11.7802;
STATES[mL] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 1.52E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 1.51E-04 : 1.629e-4);
CONSTANTS[(constants_size * offset) + thL] = 200;
STATES[hL] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.5401 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.5327 : 0.5255);
STATES[hLp] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.3034 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.2834 : 0.2872);
CONSTANTS[(constants_size * offset) + GNaL_b] = 0.0279;
CONSTANTS[(constants_size * offset) + Gto_b] = 0.16;
STATES[a] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 9.27E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 9.25E-04 : 9.5098e-4);
CONSTANTS[(constants_size * offset) + EKshift] = 0;
STATES[iF] = 0.9996;
STATES[iS] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.9996 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.5671 : 0.5936);
STATES[ap] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 4.72E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 4.71E-04 : 4.8454e-4);
STATES[iFp] = 0.9996;
STATES[iSp] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.9996 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.6261 :0.6538);
...
STATES[d] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.0 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.0 : 8.1084e-9);
CONSTANTS[(constants_size * offset) + Aff] = 0.6;
STATES[ff] = 1.0;
STATES[fs] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.9485 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.92 : 0.939);
STATES[fcaf] = 1.0;
STATES[fcas] = 0.9999;
STATES[jca] = 1.0;
STATES[ffp] = 1.0;
STATES[fcafp] = 1.0;
STATES[nca_ss] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 3.09E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 5.14E-04 : 6.6462e-4);
STATES[nca_i] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 5.30E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.0012 : 0.0012);
...
STATES[C1] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 6.79E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 6.96E-04 : 7.0344e-4);
STATES[C2] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 8.29E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 8.27E-04 : 8.5109e-4);
STATES[C3] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.9982 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.9979 : 0.9981);
STATES[I] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 9.54E-06 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 1.88E-05 : 1.3289e-5);
STATES[O] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 2.76E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 5.42E-04 : 3.7585e-4);
...
STATES[xs1] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0.2309 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0.2653 : 0.248);
STATES[xs2] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 1.70E-04 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 1.69E-04 : 1.7707e-4);
...
STATES[Jrel_np] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 2.82E-24 : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0. : 1.6129e-22);
STATES[Jrel_p] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 0. : CONSTANTS[(constants_size * offset) + celltype]==2.00000 ? 0. : 1.2475e-20);
...
ALGEBRAIC[ass] = 1.00000/(1.00000+exp(- ((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]) - 14.3400)/14.8200));
ALGEBRAIC[ta] = 1.05150/(1.00000/( 1.20890*(1.00000+exp(- ((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]) - 18.4099)/29.3814)))+3.50000/(1.00000+exp((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+100.000)/29.3814)));
ALGEBRAIC[dss] = (STATES[V]>=31.4978 ? 1.00000 :  1.07630*exp( - 1.00700*exp( - 0.0829000*STATES[V])));
ALGEBRAIC[td] = CONSTANTS[(constants_size * offset) + offset]+0.600000+1.00000/(exp( - 0.0500000*(STATES[V]+CONSTANTS[(constants_size * offset) + vShift]+6.00000))+exp( 0.0900000*(STATES[V]+CONSTANTS[(constants_size * offset) + vShift]+14.0000)));
...
ALGEBRAIC[anca_ss] = 1.00000/(CONSTANTS[(constants_size * offset) + k2n]/ALGEBRAIC[km2n]+pow(1.00000+CONSTANTS[(constants_size * offset) + Kmn]/STATES[cass], 4.00000));
ALGEBRAIC[anca_i] = 1.00000/(CONSTANTS[(constants_size * offset) + k2n]/ALGEBRAIC[km2n]+pow(1.00000+CONSTANTS[(constants_size * offset) + Kmn]/STATES[cai], 4.00000));
...
ALGEBRAIC[assp] = 1.00000/(1.00000+exp(- ((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]) - 24.3400)/14.8200));
...
ALGEBRAIC[CaMKb] = ( CONSTANTS[(constants_size * offset) + CaMKo]*(1.00000 - STATES[CaMKt]))/(1.00000+CONSTANTS[(constants_size * offset) + KmCaM]/STATES[cass]);
...
ALGEBRAIC[iss] = 1.00000/(1.00000+exp((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+43.9400)/5.71100));
ALGEBRAIC[delta_epi] = (CONSTANTS[(constants_size * offset) + celltype]==1.00000 ? 1.00000 - 0.950000/(1.00000+exp((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+70.0000)/5.00000)) : 1.00000);
ALGEBRAIC[tiF_b] = 4.56200+1.00000/( 0.393300*exp(- (STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+100.000)/100.000)+ 0.0800400*exp((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+50.0000)/16.5900));
ALGEBRAIC[tiF] =  ALGEBRAIC[tiF_b]*ALGEBRAIC[delta_epi];
ALGEBRAIC[vfrt] = ( STATES[V]*CONSTANTS[(constants_size * offset) + F])/( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T]);
...
ALGEBRAIC[tiS_b] = 23.6200+1.00000/( 0.00141600*exp(- (STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+96.5200)/59.0500)+ 1.78000e-08*exp((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+114.100)/8.07900));
...
ALGEBRAIC[dti_develop] = 1.35400+0.000100000/(exp(((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]) - 167.400)/15.8900)+exp(- ((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]) - 12.2300)/0.215400));
ALGEBRAIC[dti_recover] = 1.00000 - 0.500000/(1.00000+exp((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]+70.0000)/20.0000));
...
ALGEBRAIC[f] =  CONSTANTS[(constants_size * offset) + Aff]*STATES[ff]+ CONSTANTS[(constants_size * offset) + Afs]*STATES[fs];
...
ALGEBRAIC[fp] =  CONSTANTS[(constants_size * offset) + Aff]*STATES[ffp]+ CONSTANTS[(constants_size * offset) + Afs]*STATES[fs];
ALGEBRAIC[fcap] =  ALGEBRAIC[Afcaf]*STATES[fcafp]+ ALGEBRAIC[Afcas]*STATES[fcas];
ALGEBRAIC[vffrt] = ( STATES[V]*CONSTANTS[(constants_size * offset) + F]*CONSTANTS[(constants_size * offset) + F])/( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T]);
ALGEBRAIC[Iss] = ( 0.500000*(STATES[nass]+STATES[kss]+CONSTANTS[(constants_size * offset) + cli]+ 4.00000*STATES[cass]))/1000.00;
...
ALGEBRAIC[PhiCaL_ss] = ( 4.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_cass]*STATES[cass]*exp( 2.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_cao]*CONSTANTS[(constants_size * offset) + cao]))/(exp( 2.00000*ALGEBRAIC[vfrt]) - 1.00000);
...
ALGEBRAIC[ICaL_ss] =  CONSTANTS[(constants_size * offset) + ICaL_fractionSS]*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCa]*ALGEBRAIC[PhiCaL_ss]*STATES[d]*( ALGEBRAIC[f]*(1.00000 - STATES[nca_ss])+ STATES[jca]*ALGEBRAIC[fca]*STATES[nca_ss])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCap]*ALGEBRAIC[PhiCaL_ss]*STATES[d]*( ALGEBRAIC[fp]*(1.00000 - STATES[nca_ss])+ STATES[jca]*ALGEBRAIC[fcap]*STATES[nca_ss]));
ALGEBRAIC[Jrel_inf_b] = (( - CONSTANTS[(constants_size * offset) + a_rel]*ALGEBRAIC[ICaL_ss])/1.00000)/(1.00000+pow(CONSTANTS[(constants_size * offset) + cajsr_half]/STATES[cajsr], 8.00000));
ALGEBRAIC[Jrel_inf] = (CONSTANTS[(constants_size * offset) + celltype]==2.00000 ?  ALGEBRAIC[Jrel_inf_b]*1.70000 : ALGEBRAIC[Jrel_inf_b]);
ALGEBRAIC[tau_rel_b] = CONSTANTS[(constants_size * offset) + bt]/(1.00000+0.0123000/STATES[cajsr]);
ALGEBRAIC[tau_rel] = (ALGEBRAIC[tau_rel_b]<0.00100000 ? 0.00100000 : ALGEBRAIC[tau_rel_b]);
ALGEBRAIC[Jrel_infp_b] = (( - CONSTANTS[(constants_size * offset) + a_relp]*ALGEBRAIC[ICaL_ss])/1.00000)/(1.00000+pow(CONSTANTS[(constants_size * offset) + cajsr_half]/STATES[cajsr], 8.00000));
ALGEBRAIC[Jrel_infp] = (CONSTANTS[(constants_size * offset) + celltype]==2.00000 ?  ALGEBRAIC[Jrel_infp_b]*1.70000 : ALGEBRAIC[Jrel_infp_b]);
ALGEBRAIC[tau_relp_b] = CONSTANTS[(constants_size * offset) + btp]/(1.00000+0.0123000/STATES[cajsr]);
ALGEBRAIC[tau_relp] = (ALGEBRAIC[tau_relp_b]<0.00100000 ? 0.00100000 : ALGEBRAIC[tau_relp_b]);
ALGEBRAIC[EK] =  (( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T])/( CONSTANTS[(constants_size * offset) + zk]*CONSTANTS[(constants_size * offset) + F]))*log(CONSTANTS[(constants_size * offset) + ko]/STATES[ki]);
ALGEBRAIC[AiF] = 1.00000/(1.00000+exp(((STATES[V]+CONSTANTS[(constants_size * offset) + EKshift]) - 213.600)/151.200));
...
ALGEBRAIC[Ito] =  CONSTANTS[(constants_size * offset) + Gto]*(STATES[V] - ALGEBRAIC[EK])*( (1.00000 - ALGEBRAIC[fItop])*STATES[a]*ALGEBRAIC[i]+ ALGEBRAIC[fItop]*STATES[ap]*ALGEBRAIC[ip]);
ALGEBRAIC[IKr] =  CONSTANTS[(constants_size * offset) + GKr]* pow((CONSTANTS[(constants_size * offset) + ko]/5.00000), 1.0 / 2)*STATES[O]*(STATES[V] - ALGEBRAIC[EK]);
ALGEBRAIC[EKs] =  (( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T])/( CONSTANTS[(constants_size * offset) + zk]*CONSTANTS[(constants_size * offset) + F]))*log((CONSTANTS[(constants_size * offset) + ko]+ CONSTANTS[(constants_size * offset) + PKNa]*CONSTANTS[(constants_size * offset) + nao])/(STATES[ki]+ CONSTANTS[(constants_size * offset) + PKNa]*STATES[nai]));
ALGEBRAIC[KsCa] = 1.00000+0.600000/(1.00000+pow(3.80000e-05/STATES[cai], 1.40000));
ALGEBRAIC[IKs] =  CONSTANTS[(constants_size * offset) + GKs]*ALGEBRAIC[KsCa]*STATES[xs1]*STATES[xs2]*(STATES[V] - ALGEBRAIC[EKs]);
...
ALGEBRAIC[IK1] =  CONSTANTS[(constants_size * offset) + GK1]* pow((CONSTANTS[(constants_size * offset) + ko]/5.00000), 1.0 / 2)*ALGEBRAIC[K1ss]*(STATES[V] - ALGEBRAIC[EK]);
...
ALGEBRAIC[P] = CONSTANTS[(constants_size * offset) + eP]/(1.00000+CONSTANTS[(constants_size * offset) + H]/CONSTANTS[(constants_size * offset) + Khp]+STATES[nai]/CONSTANTS[(constants_size * offset) + Knap]+STATES[ki]/CONSTANTS[(constants_size * offset) + Kxkur]);
...
ALGEBRAIC[a1] = ( CONSTANTS[(constants_size * offset) + k1p]*pow(STATES[nai]/ALGEBRAIC[Knai], 3.00000))/((pow(1.00000+STATES[nai]/ALGEBRAIC[Knai], 3.00000)+pow(1.00000+STATES[ki]/CONSTANTS[(constants_size * offset) + Kki], 2.00000)) - 1.00000);
...
ALGEBRAIC[b4] = ( CONSTANTS[(constants_size * offset) + k4m]*pow(STATES[ki]/CONSTANTS[(constants_size * offset) + Kki], 2.00000))/((pow(1.00000+STATES[nai]/ALGEBRAIC[Knai], 3.00000)+pow(1.00000+STATES[ki]/CONSTANTS[(constants_size * offset) + Kki], 2.00000)) - 1.00000);
...
ALGEBRAIC[IKb] =  CONSTANTS[(constants_size * offset) + GKb]*ALGEBRAIC[xkb]*(STATES[V] - ALGEBRAIC[EK]);
ALGEBRAIC[I_katp] =  CONSTANTS[(constants_size * offset) + fkatp]*CONSTANTS[(constants_size * offset) + gkatp]*CONSTANTS[(constants_size * offset) + akik]*CONSTANTS[(constants_size * offset) + bkik]*(STATES[V] - ALGEBRAIC[EK]);
...
ALGEBRAIC[Ii] = ( 0.500000*(STATES[nai]+STATES[ki]+CONSTANTS[(constants_size * offset) + cli]+ 4.00000*STATES[cai]))/1000.00;
...
ALGEBRAIC[PhiCaK_i] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_ki]*STATES[ki]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_ko]*CONSTANTS[(constants_size * offset) + ko]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaK_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + ICaL_fractionSS])*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaK]*ALGEBRAIC[PhiCaK_i]*STATES[d]*( ALGEBRAIC[f]*(1.00000 - STATES[nca_i])+ STATES[jca]*ALGEBRAIC[fca]*STATES[nca_i])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaKp]*ALGEBRAIC[PhiCaK_i]*STATES[d]*( ALGEBRAIC[fp]*(1.00000 - STATES[nca_i])+ STATES[jca]*ALGEBRAIC[fcap]*STATES[nca_i]));
ALGEBRAIC[JdiffK] = (STATES[kss] - STATES[ki])/CONSTANTS[(constants_size * offset) + tauK];
...
ALGEBRAIC[PhiCaK_ss] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_kss]*STATES[kss]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_ko]*CONSTANTS[(constants_size * offset) + ko]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaK_ss] =  CONSTANTS[(constants_size * offset) + ICaL_fractionSS]*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaK]*ALGEBRAIC[PhiCaK_ss]*STATES[d]*( ALGEBRAIC[f]*(1.00000 - STATES[nca_ss])+ STATES[jca]*ALGEBRAIC[fca]*STATES[nca_ss])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaKp]*ALGEBRAIC[PhiCaK_ss]*STATES[d]*( ALGEBRAIC[fp]*(1.00000 - STATES[nca_ss])+ STATES[jca]*ALGEBRAIC[fcap]*STATES[nca_ss]));
ALGEBRAIC[ENa] =  (( CONSTANTS[(constants_size * offset) + R]*CONSTANTS[(constants_size * offset) + T])/( CONSTANTS[(constants_size * offset) + zna]*CONSTANTS[(constants_size * offset) + F]))*log(CONSTANTS[(constants_size * offset) + nao]/STATES[nai]);
ALGEBRAIC[fINap] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[INa] =  CONSTANTS[(constants_size * offset) + GNa]*(STATES[V] - ALGEBRAIC[ENa])*pow(STATES[m], 3.00000)*( (1.00000 - ALGEBRAIC[fINap])*STATES[h]*STATES[j]+ ALGEBRAIC[fINap]*STATES[hp]*STATES[jp]);
ALGEBRAIC[fINaLp] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[INaL] =  CONSTANTS[(constants_size * offset) + GNaL]*(STATES[V] - ALGEBRAIC[ENa])*STATES[mL]*( (1.00000 - ALGEBRAIC[fINaLp])*STATES[hL]+ ALGEBRAIC[fINaLp]*STATES[hLp]);
ALGEBRAIC[allo_i] = 1.00000/(1.00000+pow(CONSTANTS[(constants_size * offset) + KmCaAct]/STATES[cai], 2.00000));
...
ALGEBRAIC[h1_i] = 1.00000+ (STATES[nai]/CONSTANTS[(constants_size * offset) + kna3])*(1.00000+ALGEBRAIC[hna]);
ALGEBRAIC[h2_i] = ( STATES[nai]*ALGEBRAIC[hna])/( CONSTANTS[(constants_size * offset) + kna3]*ALGEBRAIC[h1_i]);
ALGEBRAIC[k4pp_i] =  ALGEBRAIC[h2_i]*CONSTANTS[(constants_size * offset) + wnaca];
ALGEBRAIC[h4_i] = 1.00000+ (STATES[nai]/CONSTANTS[(constants_size * offset) + kna1])*(1.00000+STATES[nai]/CONSTANTS[(constants_size * offset) + kna2]);
ALGEBRAIC[h5_i] = ( STATES[nai]*STATES[nai])/( ALGEBRAIC[h4_i]*CONSTANTS[(constants_size * offset) + kna1]*CONSTANTS[(constants_size * offset) + kna2]);
...
ALGEBRAIC[k6_i] =  ALGEBRAIC[h6_i]*STATES[cai]*CONSTANTS[(constants_size * offset) + kcaon];
...
ALGEBRAIC[INab] = ( CONSTANTS[(constants_size * offset) + PNab]*ALGEBRAIC[vffrt]*( STATES[nai]*exp(ALGEBRAIC[vfrt]) - CONSTANTS[(constants_size * offset) + nao]))/(exp(ALGEBRAIC[vfrt]) - 1.00000);
...
ALGEBRAIC[PhiCaNa_i] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_nai]*STATES[nai]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_nao]*CONSTANTS[(constants_size * offset) + nao]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaNa_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + ICaL_fractionSS])*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaNa]*ALGEBRAIC[PhiCaNa_i]*STATES[d]*( ALGEBRAIC[f]*(1.00000 - STATES[nca_i])+ STATES[jca]*ALGEBRAIC[fca]*STATES[nca_i])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaNap]*ALGEBRAIC[PhiCaNa_i]*STATES[d]*( ALGEBRAIC[fp]*(1.00000 - STATES[nca_i])+ STATES[jca]*ALGEBRAIC[fcap]*STATES[nca_i]));
ALGEBRAIC[JdiffNa] = (STATES[nass] - STATES[nai])/CONSTANTS[(constants_size * offset) + tauNa];
ALGEBRAIC[allo_ss] = 1.00000/(1.00000+pow(CONSTANTS[(constants_size * offset) + KmCaAct]/STATES[cass], 2.00000));
...
ALGEBRAIC[h1_ss] = 1.00000+ (STATES[nass]/CONSTANTS[(constants_size * offset) + kna3])*(1.00000+ALGEBRAIC[hna]);
ALGEBRAIC[h2_ss] = ( STATES[nass]*ALGEBRAIC[hna])/( CONSTANTS[(constants_size * offset) + kna3]*ALGEBRAIC[h1_ss]);
ALGEBRAIC[k4pp_ss] =  ALGEBRAIC[h2_ss]*CONSTANTS[(constants_size * offset) + wnaca];
ALGEBRAIC[h4_ss] = 1.00000+ (STATES[nass]/CONSTANTS[(constants_size * offset) + kna1])*(1.00000+STATES[nass]/CONSTANTS[(constants_size * offset) + kna2]);
ALGEBRAIC[h5_ss] = ( STATES[nass]*STATES[nass])/( ALGEBRAIC[h4_ss]*CONSTANTS[(constants_size * offset) + kna1]*CONSTANTS[(constants_size * offset) + kna2]);
...
ALGEBRAIC[k6_ss] =  ALGEBRAIC[h6_ss]*STATES[cass]*CONSTANTS[(constants_size * offset) + kcaon];
...
ALGEBRAIC[PhiCaNa_ss] = ( 1.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_nass]*STATES[nass]*exp( 1.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_nao]*CONSTANTS[(constants_size * offset) + nao]))/(exp( 1.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaNa_ss] =  CONSTANTS[(constants_size * offset) + ICaL_fractionSS]*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCaNa]*ALGEBRAIC[PhiCaNa_ss]*STATES[d]*( ALGEBRAIC[f]*(1.00000 - STATES[nca_ss])+ STATES[jca]*ALGEBRAIC[fca]*STATES[nca_ss])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCaNap]*ALGEBRAIC[PhiCaNa_ss]*STATES[d]*( ALGEBRAIC[fp]*(1.00000 - STATES[nca_ss])+ STATES[jca]*ALGEBRAIC[fcap]*STATES[nca_ss]));
ALGEBRAIC[Jdiff] = (STATES[cass] - STATES[cai])/CONSTANTS[(constants_size * offset) + tauCa];
ALGEBRAIC[fJrelp] = 1.00000/(1.00000+CONSTANTS[(constants_size * offset) + KmCaMK]/ALGEBRAIC[CaMKa]);
ALGEBRAIC[Jrel] =  CONSTANTS[(constants_size * offset) + Jrel_b]*( (1.00000 - ALGEBRAIC[fJrelp])*STATES[Jrel_np]+ ALGEBRAIC[fJrelp]*STATES[Jrel_p]);
ALGEBRAIC[Bcass] = 1.00000/(1.00000+( CONSTANTS[(constants_size * offset) + BSRmax]*CONSTANTS[(constants_size * offset) + KmBSR])/pow(CONSTANTS[(constants_size * offset) + KmBSR]+STATES[cass], 2.00000)+( CONSTANTS[(constants_size * offset) + BSLmax]*CONSTANTS[(constants_size * offset) + KmBSL])/pow(CONSTANTS[(constants_size * offset) + KmBSL]+STATES[cass], 2.00000));
...
ALGEBRAIC[PhiCaL_i] = ( 4.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_cai]*STATES[cai]*exp( 2.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_cao]*CONSTANTS[(constants_size * offset) + cao]))/(exp( 2.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[ICaL_i] =  (1.00000 - CONSTANTS[(constants_size * offset) + ICaL_fractionSS])*( (1.00000 - ALGEBRAIC[fICaLp])*CONSTANTS[(constants_size * offset) + PCa]*ALGEBRAIC[PhiCaL_i]*STATES[d]*( ALGEBRAIC[f]*(1.00000 - STATES[nca_i])+ STATES[jca]*ALGEBRAIC[fca]*STATES[nca_i])+ ALGEBRAIC[fICaLp]*CONSTANTS[(constants_size * offset) + PCap]*ALGEBRAIC[PhiCaL_i]*STATES[d]*( ALGEBRAIC[fp]*(1.00000 - STATES[nca_i])+ STATES[jca]*ALGEBRAIC[fcap]*STATES[nca_i]));
...
ALGEBRAIC[IpCa] = ( CONSTANTS[(constants_size * offset) + GpCa]*STATES[cai])/(CONSTANTS[(constants_size * offset) + KmCap]+STATES[cai]);
ALGEBRAIC[ICab] = ( CONSTANTS[(constants_size * offset) + PCab]*4.00000*ALGEBRAIC[vffrt]*( ALGEBRAIC[gamma_cai]*STATES[cai]*exp( 2.00000*ALGEBRAIC[vfrt]) -  CONSTANTS[(constants_size * offset) + gamma_cao]*CONSTANTS[(constants_size * offset) + cao]))/(exp( 2.00000*ALGEBRAIC[vfrt]) - 1.00000);
ALGEBRAIC[IClCa_junc] =  (( CONSTANTS[(constants_size * offset) + Fjunc]*CONSTANTS[(constants_size * offset) + GClCa])/(1.00000+CONSTANTS[(constants_size * offset) + KdClCa]/STATES[cass]))*(STATES[V] - CONSTANTS[(constants_size * offset) + ECl]);
ALGEBRAIC[IClCa_sl] =  (( (1.00000 - CONSTANTS[(constants_size * offset) + Fjunc])*CONSTANTS[(constants_size * offset) + GClCa])/(1.00000+CONSTANTS[(constants_size * offset) + KdClCa]/STATES[cai]))*(STATES[V] - CONSTANTS[(constants_size * offset) + ECl]);
ALGEBRAIC[IClCa] = ALGEBRAIC[IClCa_junc]+ALGEBRAIC[IClCa_sl];
ALGEBRAIC[IClb] =  CONSTANTS[(constants_size * offset) + GClb]*(STATES[V] - CONSTANTS[(constants_size * offset) + ECl]);
ALGEBRAIC[Jupnp] = ( CONSTANTS[(constants_size * offset) + upScale]*0.00542500*STATES[cai])/(STATES[cai]+0.000920000);
ALGEBRAIC[Jupp] = ( CONSTANTS[(constants_size * offset) + upScale]*2.75000*0.00542500*STATES[cai])/((STATES[cai]+0.000920000) - 0.000170000);
...
ALGEBRAIC[Bcai] = 1.00000/(1.00000+( CONSTANTS[(constants_size * offset) + cmdnmax]*CONSTANTS[(constants_size * offset) + kmcmdn])/pow(CONSTANTS[(constants_size * offset) + kmcmdn]+STATES[cai], 2.00000)+( CONSTANTS[(constants_size * offset) + trpnmax]*CONSTANTS[(constants_size * offset) + kmtrpn])/pow(CONSTANTS[(constants_size * offset) + kmtrpn]+STATES[cai], 2.00000));
ALGEBRAIC[Jtr] = (STATES[cansr] - STATES[cajsr])/60.0000;
ALGEBRAIC[Bcajsr] = 1.00000/(1.00000+( CONSTANTS[(constants_size * offset) + csqnmax]*CONSTANTS[(constants_size * offset) + kmcsqn])/pow(CONSTANTS[(constants_size * offset) + kmcsqn]+STATES[cajsr], 2.00000));

RATES[hL] = (ALGEBRAIC[hLss] - STATES[hL])/CONSTANTS[(constants_size * offset) + thL];
RATES[hLp] = (ALGEBRAIC[hLssp] - STATES[hLp])/CONSTANTS[(constants_size * offset) + thLp];
RATES[jca] = (ALGEBRAIC[jcass] - STATES[jca])/CONSTANTS[(constants_size * offset) + tjca];
...
RATES[nca_ss] =  ALGEBRAIC[anca_ss]*CONSTANTS[(constants_size * offset) + k2n] -  STATES[nca_ss]*ALGEBRAIC[km2n];
RATES[nca_i] =  ALGEBRAIC[anca_i]*CONSTANTS[(constants_size * offset) + k2n] -  STATES[nca_i]*ALGEBRAIC[km2n];
...
RATES[CaMKt] =  CONSTANTS[(constants_size * offset) + aCaMK]*ALGEBRAIC[CaMKb]*(ALGEBRAIC[CaMKb]+STATES[CaMKt]) -  CONSTANTS[(constants_size * offset) + bCaMK]*STATES[CaMKt];
...
RATES[C2] = ( ALGEBRAIC[alpha]*STATES[C3]+ CONSTANTS[(constants_size * offset) + beta_1]*STATES[C1]) -  (ALGEBRAIC[beta]+CONSTANTS[(constants_size * offset) + alpha_1])*STATES[C2];
...
RATES[C1] = ( CONSTANTS[(constants_size * offset) + alpha_1]*STATES[C2]+ ALGEBRAIC[beta_2]*STATES[O]+ ALGEBRAIC[beta_ItoC2]*STATES[I]) -  (CONSTANTS[(constants_size * offset) + beta_1]+ALGEBRAIC[alpha_2]+ALGEBRAIC[alpha_C2ToI])*STATES[C1];
...
////INa
  ...
  STATES[hL] = ALGEBRAIC[hLss] - (ALGEBRAIC[hLss] - STATES[hL]) * exp(-dt / CONSTANTS[(constants_size * offset) + thL]);
  STATES[hLp] = ALGEBRAIC[hLssp] - (ALGEBRAIC[hLssp] - STATES[hLp]) * exp(-dt / CONSTANTS[(constants_size * offset) + thLp]);
////Ito
...
////ICaL
  ...
  STATES[jca] = ALGEBRAIC[jcass] - (ALGEBRAIC[jcass] - STATES[jca]) * exp(- dt / CONSTANTS[(constants_size * offset) + tjca]);
