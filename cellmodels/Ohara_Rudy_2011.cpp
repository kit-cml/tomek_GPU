...
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + hca] = exp(( CONSTANTS[(offset * num_of_constants) + qca]*STATES[(offset * num_of_states) + V]*CONSTANTS[(offset * num_of_constants) + F])/( CONSTANTS[(offset * num_of_constants) + R]*CONSTANTS[(offset * num_of_constants) + T]));
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + h3_i] = 1.00000/ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + h1_i];
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4p_i] = ( ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + h3_i]*CONSTANTS[(offset * num_of_constants) + wca])/ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + hca];
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4_i] = ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4p_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4pp_i];
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + h6_i] = 1.00000/ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + h4_i];
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k6_i] =  ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + h6_i]*STATES[(offset * num_of_states) + cai]*CONSTANTS[(offset * num_of_constants) + kcaon];
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x1_i] =  CONSTANTS[(offset * num_of_constants) + k2_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4_i]*(ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k7_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k6_i])+ CONSTANTS[(offset * num_of_constants) + k5_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k7_i]*(CONSTANTS[(offset * num_of_constants) + k2_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k3_i]);
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x2_i] =  CONSTANTS[(offset * num_of_constants) + k1_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k7_i]*(ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4_i]+CONSTANTS[(offset * num_of_constants) + k5_i])+ ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k6_i]*(CONSTANTS[(offset * num_of_constants) + k1_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k8_i]);
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x3_i] =  CONSTANTS[(offset * num_of_constants) + k1_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k3_i]*(ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k7_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k6_i])+ ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k8_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k6_i]*(CONSTANTS[(offset * num_of_constants) + k2_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k3_i]);
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x4_i] =  CONSTANTS[(offset * num_of_constants) + k2_i]*ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k8_i]*(ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k4_i]+CONSTANTS[(offset * num_of_constants) + k5_i])+ ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k3_i]*CONSTANTS[(offset * num_of_constants) + k5_i]*(CONSTANTS[(offset * num_of_constants) + k1_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + k8_i]);
ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + E1_i] = ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x1_i]/(ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x1_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x2_i]+ALGEBRAIC[(offset * num_of_algebraic) + (offset * num_of_algebraic) + x3_i]+ALGEBRAIC[(offset * num_of_algebraic) + x4_i]);
