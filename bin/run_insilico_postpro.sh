...
"./drug_sim" -input_deck ./input_deck.txt -hill_file ./drugs/$drugname/IC50_optimal.csv
...
"./drug_sim" -input_deck ./input_deck.txt -hill_file ./drugs/$drugname/IC50_optimal.csv -init_file ./result/$formatted_concentration.csv
